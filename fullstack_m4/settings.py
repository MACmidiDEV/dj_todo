"""
Django settings for fullstack_m4 project.
...
SECRET_KEY = 'ybylcdt4pxghz&sahw!+m(*w(v#-7vde+_wh0try3vqe&i+n74'
...
ROOT_URLCONF = 'fullstack_m4.urls'
...
WSGI_APPLICATION = 'fullstack_m4.wsgi.application'
